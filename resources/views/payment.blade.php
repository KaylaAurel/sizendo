...
document.getElementById('paymentForm').addEventListener('submit', async function(e) {
  ...
  try {
    // 1) Kirim data ke backend: server akan SIMPAN data + generate token
    ...
    // 2) Ambil token dari response (data sudah tersimpan di DB)
    ...
    window.snap.pay(token, {
      onSuccess: function(result) {
        ...
        window.location.href = "/"; // atau ke halaman thank you
      },
